...
namespace prototipo1204.Data
{
    public class oceanidDBContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            // relacionamento clientefavorito - cliente
            modelBuilder.Entity<ClienteFavorito>()
                .HasOne(cf => cf.Cliente)
                .WithMany(c => c.ClienteFavoritos)
                .HasForeignKey(cf => cf.IdCliente)
                .OnDelete(DeleteBehavior.Cascade);


            // relacionamento clientefavorito - produto 
            modelBuilder.Entity<ClienteFavorito>()
                .HasOne(cf => cf.Produto)
                .WithMany(p => p.ClienteFavoritos)
